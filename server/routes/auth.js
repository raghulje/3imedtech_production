...
router.get("/verify", (req, res, next) => {
  console.log('🔍 [VERIFY ROUTE] Verify route handler called');
  next();
}, authMiddleware.authCheck, (req, res) => {
  console.log('✅ [AUTH VERIFY] Token verified successfully, sending response');
  // If we reach here, the token is valid (authCheck passed)
  res.json({ success: true, message: "Token is valid", user: req.userData });
});
