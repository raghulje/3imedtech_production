const { AboutHero, AboutVisionMission, AboutSection, ValueItem, JourneyItem, AboutJourney } = require("../models");
...
exports.getAll = asyncHandler(async (req, res) => {
  const [hero, vm, sections, values, journey, aboutJourney] = await Promise.all([
