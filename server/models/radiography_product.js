...
module.exports = (sequelize, DataTypes) => {
  const RadiographyProduct = sequelize.define(
    "RadiographyProduct",
    {
      ...
      sectionId: { type: DataTypes.STRING, allowNull: true }, // For hash navigation (e.g., "dreamcmtdual")
    ...
    { tableName: "radiography_products", underscored: true, paranoid: false }
  );

  return RadiographyProduct;
};
