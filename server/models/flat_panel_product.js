...
module.exports = (sequelize, DataTypes) => {
  const FlatPanelProduct = sequelize.define(
    "FlatPanelProduct",
    {
      ...
      sectionId: { type: DataTypes.STRING, allowNull: true }, // For hash navigation (e.g., "glassfreeflatpaneldetector")
    ...
    { tableName: "flat_panel_products", underscored: true, paranoid: false }
  );

  return FlatPanelProduct;
};
