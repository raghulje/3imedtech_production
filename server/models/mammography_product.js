...
module.exports = (sequelize, DataTypes) => {
  const MammographyProduct = sequelize.define(
    "MammographyProduct",
    {
      ...
      sectionId: { type: DataTypes.STRING, allowNull: true }, // For hash navigation (e.g., "pinkviewdrplus")
    ...
    { tableName: "mammography_products", underscored: true, paranoid: false }
  );

  return MammographyProduct;
};
