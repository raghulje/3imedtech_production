      ...
      {products.length > 0 ? (
        ...
        <>
          ...
          <section
            ...
            className={`py-8 md:py-12 lg:py-20 bg-white relative overflow-hidden transition-all duration-500 ${highlightedSection === 'glassfreeflatpaneldetector' ? 'ring-4 ring-[#E6662F] ring-opacity-75 shadow-2xl' : ''
              }`}
            style={{
              scrollMarginTop: '100px',
          ...
          <section
            ...
            className={`py-8 md:py-12 lg:py-20 bg-[#F8F9FA] relative overflow-hidden transition-all duration-500 ${highlightedSection === 'retrofitmammographypanel' ? 'ring-4 ring-[#E6662F] ring-opacity-75 shadow-2xl' : ''
              }`}
            style={{
              scrollMarginTop: '100px',
              background: 'linear-gradient(180deg, rgba(0, 0, 0, 0) 10%, #2879b6 90%)'
